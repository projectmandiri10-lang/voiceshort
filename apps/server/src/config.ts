...
import { DEFAULT_AIVENE_BASE_URL, DEFAULT_AIVENE_SCRIPT_MODEL, DEFAULT_PORT } from "./constants.js";
...
function provider(value: string | undefined, fallback: AppEnv["scriptProvider"]): AppEnv["scriptProvider"] {
  return value === "aivene" || value === "openrouter" ? value : fallback;
}
...
export function loadEnv(): AppEnv {
  ...
  if ((scriptProvider === "openrouter" || scriptFallbackProvider === "openrouter") && !openrouterApiKey) {
